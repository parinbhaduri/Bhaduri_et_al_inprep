...
averse_plots = simul_plot(adf_averse, :risk_averse; leg = :outertopright, color = palette(:BrBG_6), lim = (3000,15000))
...
mem_plots = simul_plot(adf_mem, :flood_mem, color = palette(:Blues_8), lim = (3000,15000))
